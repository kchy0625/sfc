...
urlpatterns = [
    ...
    path('facecam_feed1/', StaffViews.facecam_feed1, name='facecam_feed1'),
    path('save_subject_for_check/',StaffViews.save_subject_for_check, name="save_subject_for_check"),
    path('staff_feedback/', StaffViews.staff_feedback, name="staff_feedback"),
    path('student_feedback_message_reply/', StaffViews.student_feedback_message_reply, name="student_feedback_message_reply"),
    path('get_subjects/', StaffViews.get_subjects, name="get_subjects"),
    path('get_student_check/', StaffViews.get_student_check, name="get_student_check"),
